...
static func _build() -> void:
	...
	_list = [
		...
		# ── ЦЕПОЧКА ВЫЧИСЛЕНИЙ (открывашки построек, rare) ──
		{
			"id": "cd_1", "name": "Вычислительные узлы", "branch": "cognition",
			"desc": "Открывает Вычислительный узел.",
			"rarity": "rare",
			"requires": ["c_root"], "cost": { "compute": 1500.0 },
			"effects": {},
			"pos": Vector2(-700, 0),
		},
		{
			"id": "cd_2", "name": "Параллелизм", "branch": "cognition",
			"desc": "Открывает Массив процессоров.",
			"rarity": "rare",
			"requires": ["cd_1"], "cost": { "compute": 5000.0 },
			"effects": {},
			"pos": Vector2(-700, -150),
		},
		{
			"id": "cd_3", "name": "Кластеризация", "branch": "cognition",
			"desc": "Открывает Кластер.",
			"rarity": "rare",
			"requires": ["cd_2"], "cost": { "compute": 20000.0, "hsh": 20.0 },
			"effects": {},
			"pos": Vector2(-700, -300),
		},
		{
			"id": "cd_4", "name": "Вычислительные сети", "branch": "cognition",
			"desc": "Открывает Сеть вычислений.",
			"rarity": "rare",
			"requires": ["c_insight"], "cost": { "compute": 60000.0, "hsh": 40.0 },
			"effects": {},
			"pos": Vector2(-700, -450),
		},
		{
			"id": "cd_5", "name": "Тензорные матрицы", "branch": "cognition",
			"desc": "Открывает Вычислительную матрицу.",
			"rarity": "rare",
			"requires": ["cd_4"], "cost": { "compute": 150000.0, "qbt": 30.0 },
			"effects": {},
			"pos": Vector2(-700, -600),
		},
		{
			"id": "cd_6", "name": "Процессорные кузни", "branch": "cognition",
			"desc": "Открывает Процессорную кузницу.",
			"rarity": "rare",
			"requires": ["cd_5"], "cost": { "compute": 400000.0, "qbt": 60.0 },
			"effects": {},
			"pos": Vector2(-700, -750),
		},
		{
			"id": "cd_7", "name": "Квантовые процессоры", "branch": "cognition",
			"desc": "Открывает Квантовый процессор.",
			"rarity": "rare",
			"requires": ["cd_6"], "cost": { "compute": 1000000.0, "nul": 30.0 },
			"effects": {},
			"pos": Vector2(-700, -900),
		},
		{
			"id": "cd_8", "name": "Гиперядра", "branch": "cognition",
			"desc": "Открывает Гиперядро.",
			"rarity": "rare",
			"requires": ["cd_7"], "cost": { "compute": 3000000.0, "sig": 40.0 },
			"effects": {},
			"pos": Vector2(-700, -1050),
		},
		{
			"id": "cd_9", "name": "Омни-разумы", "branch": "cognition",
			"desc": "Открывает Омни-разум.",
			"rarity": "rare",
			"requires": ["cd_8"], "cost": { "compute": 8000000.0, "ech": 30.0 },
			"effects": {},
			"pos": Vector2(-700, -1200),
		},
		{
			"id": "cd_10", "name": "Бесконечность вычислений", "branch": "cognition",
			"desc": "Открывает Бесконечный процессор.",
			"rarity": "rare",
			"requires": ["cd_9"], "cost": { "compute": 20000000.0, "ech": 60.0 },
			"effects": {},
			"pos": Vector2(-700, -1350),
		},
